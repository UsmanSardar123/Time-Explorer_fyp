...
router.post('/', auth.verifyToken, validate.userCreate, usersController.createUser);
router.put('/:uid', auth.verifyToken, validate.userUpdate, usersController.updateUser);
